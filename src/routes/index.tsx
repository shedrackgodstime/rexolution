          ...
          <div class="flex flex-col items-center text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 text-left border-t border-brand-gold/10 pt-16">
              ...
              <div class="space-y-6">
                ...
                <p class="font-body text-sm leading-relaxed text-brand-muted tracking-wide">
                  Every stitch is intentional. Every fit is a direction. We believe style isn't about fitting in—it's about the unapologetic act of evolving into your most potent self.
                </p>
              </div>
            </div>
