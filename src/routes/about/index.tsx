    ...
    <div class="bg-brand-black min-h-screen pt-40 pb-24 overflow-hidden">
      ...
      <section class="container mx-auto px-6 md:px-12 relative z-10 mb-40">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          {/* Header & Copy */}
          <div
            class={`lg:col-span-7 flex flex-col transition-all duration-1000 ease-out ${isLoaded.value ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
              }`}
          >
          ...
          {/* Featured Editorial */}
          <div
            class={`lg:col-span-5 relative transition-all duration-1000 delay-300 ease-out ${isLoaded.value ? 'translate-x-0 opacity-100' : 'translate-x-12 opacity-0'
              }`}
          >
